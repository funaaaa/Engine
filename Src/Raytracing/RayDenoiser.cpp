...
void Denoiser::MixColorAndLuminance(int InputColorIndex, int InputLightLuminanceIndex, int InputEmissiveIndex, int InputFogIndex, int OutputUAVIndex)
{

	/*===== 色情報と明るさ情報の乗算 =====*/

	// コンピュートシェーダーを実行。
	mixColorAndLuminance_->ChangeInputUAVIndex({ InputColorIndex, InputLightLuminanceIndex, InputEmissiveIndex, InputFogIndex });
