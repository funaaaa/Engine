...
void PlayerModel::Load(COLOR ColorID, bool IsGhost)
{
	...
	if (IsGhost) {
		...
		// 車のボディをロード
		carBodyBlas_ = BLASRegister::Ins()->GenerateFbx("Resource/Game/Car/" + folder, "body.fbx", HitGroupMgr::Ins()->hitGroupNames[HitGroupMgr::DEF], true, true);
		...
		// 車のバンパーをロード
		carBumperBlas_ = BLASRegister::Ins()->GenerateFbx("Resource/Game/Car/" + folder, "bumper.fbx", HitGroupMgr::Ins()->hitGroupNames[HitGroupMgr::DEF], true, true);
		...
		// 車のライトをロード
		carLeftLightBlas_ = BLASRegister::Ins()->GenerateFbx("Resource/Game/Car/" + folder, "leftLight.fbx", HitGroupMgr::Ins()->hitGroupNames[HitGroupMgr::DEF], true, true);
		...
		// 車のライトをロード
		carRightLightBlas_ = BLASRegister::Ins()->GenerateFbx("Resource/Game/Car/" + folder, "rightLight.fbx", HitGroupMgr::Ins()->hitGroupNames[HitGroupMgr::DEF], true, true);
		...
		// 車のライトをロード
		carFrontLightBlas_ = BLASRegister::Ins()->GenerateFbx("Resource/Game/Car/" + folder, "frontLight.fbx", HitGroupMgr::Ins()->hitGroupNames[HitGroupMgr::DEF], true, true);
		...
		// 車の後ろタイヤをロード
		carBehindTireBlas_ = BLASRegister::Ins()->GenerateFbx("Resource/Game/Car/" + folder, "behindTire.fbx", HitGroupMgr::Ins()->hitGroupNames[HitGroupMgr::DEF], true, true);
		...
		// 車の後ろタイヤのフレームをロード
		carBehindTireFrameBlas_ = BLASRegister::Ins()->GenerateFbx("Resource/Game/Car/" + folder, "behindTireFrame.fbx", HitGroupMgr::Ins()->hitGroupNames[HitGroupMgr::DEF], true, true);
		...
		// 右前タイヤをロード
		carRightTireBlas_ = BLASRegister::Ins()->GenerateFbx("Resource/Game/Car/" + folder, "rightTire.fbx", HitGroupMgr::Ins()->hitGroupNames[HitGroupMgr::DEF], true, true);
		...
		// 右前タイヤのフレームをロード
		carRightTireFrameBlas_ = BLASRegister::Ins()->GenerateFbx("Resource/Game/Car/" + folder, "rightTireFrame.fbx", HitGroupMgr::Ins()->hitGroupNames[HitGroupMgr::DEF], true, true);
		...
		// 左前タイヤをロード
		carLeftTireBlas_ = BLASRegister::Ins()->GenerateFbx("Resource/Game/Car/" + folder, "leftTire.fbx", HitGroupMgr::Ins()->hitGroupNames[HitGroupMgr::DEF], true, true);
		...
		// 左前タイヤのフレームをロード
		carLeftTireFrameBlas_ = BLASRegister::Ins()->GenerateFbx("Resource/Game/Car/" + folder, "leftTireFrame.fbx", HitGroupMgr::Ins()->hitGroupNames[HitGroupMgr::DEF], true, true);
		...
		// 車の鏡をロード
		carMirrorBlas_ = BLASRegister::Ins()->GenerateFbx("Resource/Game/Car/" + folder, "mirror.fbx", HitGroupMgr::Ins()->hitGroupNames[HitGroupMgr::DEF], true, true);
		...
		// 車の鏡のカバーをロード
		carMirrorCoverBlas_ = BLASRegister::Ins()->GenerateFbx("Resource/Game/Car/" + folder, "mirrorCover.fbx", HitGroupMgr::Ins()->hitGroupNames[HitGroupMgr::DEF], true, true);
		...
		// 車のウィンドウをロード
		carWindowBlas_ = BLASRegister::Ins()->GenerateFbx("Resource/Game/Car/" + folder, "window.fbx", HitGroupMgr::Ins()->hitGroupNames[HitGroupMgr::DEF], true, true);
