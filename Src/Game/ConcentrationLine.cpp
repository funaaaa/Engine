...
ConcentrationLine::ConcentrationLine()
{
	...
	sprite_->GenerateForTexture(Vec3(0, 0, 0), Vec2(512.0f, 32.0f), Pipeline::PROJECTIONID::UI, Pipeline::BLEND_ID::BLENDMODE_ALPHA, L"Resource/Game/UI/concentrationLine.dds");
	alpha_ = 0;
	exitTimer_ = 0;
	isActive_ = false;
