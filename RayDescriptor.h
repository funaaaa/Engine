...
public:
	...
	// SRV生成処理
	void CreateStructuredSRV(ComPtr<ID3D12Resource> resource, UINT numElements, UINT firstElement, UINT stride, ComPtr<ID3D12DescriptorHeap>& descHeap, UINT index);
